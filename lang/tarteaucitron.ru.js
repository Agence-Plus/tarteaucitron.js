...
tarteaucitron.lang = {
    ...
    "alertBigPrivacyTitle": "Файлы cookie на нашем веб-сайте",
    "alertBigPrivacy": "использует файлы cookie для персонализации контента и предоставления вам индивидуального опыта. Вы можете управлять своими предпочтениями и узнать больше, нажав на « Настройки », а также в любое время в нижней части сайта, нажав на « Управление файлами cookie ».",
    "alertSmall": "Настройка сервисов",
    "personalize": "Настройки",
    "acceptAll": "Ок, все активировать",
    "close": "Закрыть",
    "closeBanner": "Продолжить без принятия",
    ...
    "disclaimer": "использует файлы cookie для персонализации контента и предоставления вам индивидуального опыта. Активирование сервисов третьих лиц позволяет использование их кукис и технолоний отслеживания необходимых для их функционирования",
    "allow": "Позволить",
    "deny": "Не позволить",
